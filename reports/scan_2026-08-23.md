# Elliott Hybrid Scanner — 2026-08-23 04:55 UTC
...
- **Timeframe**: 4h, señal confirmada el 2026-08-22 16:00 UTC (2 velas atrás)
...
|---|---|---|---|---|---|
| TRX/USDT | `impulse_1_2_3` | 0.574 | market_structure, volume_profile, higher_timeframe_trend | 0.3398–0.3434 | 0.3376 |
| SUI/USDT | `impulse_1_2_3` | 0.536 | market_structure, volume_profile, higher_timeframe_trend | 0.7029–0.7642 | 0.7003 |
| PEPE/USDT | `corrective_abc` | 0.497 | market_structure, volume_profile, higher_timeframe_trend | 0.0000–0.0000 | 0.0000 |
| ETH/USDT | `corrective_abc` | 0.492 | market_structure, volume_profile, higher_timeframe_trend | 1,883.46–1,964.32 | 1,853.62 |
| LINK/USDT | `impulse_1_2_3` | 0.437 | market_structure, volume_profile, higher_timeframe_trend | 10.4613–11.1047 | 8.4550 |
| BNB/USDT | `impulse_1_2_3` | 0.435 | market_structure, higher_timeframe_trend | 631.82–652.85 | 605.50 |
| DOT/USDT | `corrective_abc` | 0.418 | market_structure, higher_timeframe_trend | 0.7461–0.7974 | 0.7230 |
| BTC/USDT | `corrective_abc` | 0.370 | market_structure, higher_timeframe_trend | 63,841.99–65,635.54 | 62,275.00 |
| SOL/USDT | `corrective_abc` | 0.370 | market_structure, higher_timeframe_trend | 74.4736–78.8039 | 74.1000 |
