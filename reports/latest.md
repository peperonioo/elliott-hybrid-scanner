# Elliott Hybrid Scanner — 2026-08-16 13:05 UTC
...
- **Timeframe**: 4h, señal confirmada el 2026-08-15 12:00 UTC (5 velas atrás)
...
|---|---|---|---|---|---|
| BTC/USDT | `corrective_abc` | 0.348 | rsi_divergence, volume_profile | 64,380.14–64,815.43 | 62,742.47 |
...
| ETH/USDT | `corrective_abc` | 0.239 | volume_profile | 1,900.53–1,917.21 | 1,853.62 |
| BNB/USDT | `impulse_1_2_3` | 0.237 | higher_timeframe_trend | 638.73–645.94 | 605.50 |
| SOL/USDT | `corrective_abc` | 0.229 | volume_profile | 74.4285–75.2846 | 70.5800 |
| PEPE/USDT | `corrective_abc` | 0.178 | volume_profile | 0.0000–0.0000 | 0.0000 |
| SUI/USDT | `impulse_1_2_3` | 0.155 | volume_profile | 0.7286–0.7385 | 0.7003 |
| ADA/USDT | `corrective_abc` | 0.154 | — | 0.1651–0.1687 | 0.1578 |
| DOGE/USDT | `corrective_abc` | 0.136 | volume_profile | 0.0698–0.0707 | 0.0682 |
| XRP/USDT | `corrective_abc` | 0.000 | — | 1.0714–1.0822 | 1.0473 |
